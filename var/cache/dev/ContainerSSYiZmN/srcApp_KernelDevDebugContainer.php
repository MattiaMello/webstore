...
class srcApp_KernelDevDebugContainer extends Container
{
     ...
     */
    protected function getProductsControllerService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ControllerTrait.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        ...
        $this->services['App\\Controller\\ProductsController'] = $instance = new \App\Controller\ProductsController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\ProductsController', $this));
    ...
    protected function getReportControllerService()
    {
        ...
        $this->services['App\\Controller\\ReportController'] = $instance = new \App\Controller\ReportController();
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Jp7fO5GPO8', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QeZgKGKXqX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getCache_SystemClearerService()
    {
        ...
        return $this->services['cache.system_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\Psr6CacheClearer(['cache.system' => ($this->services['cache.system'] ?? $this->getCache_SystemService()), 'cache.annotations' => ($this->privates['cache.annotations'] ?? $this->getCache_AnnotationsService()), 'cache.webpack_encore' => ($this->privates['cache.webpack_encore'] ?? $this->getCache_WebpackEncoreService())]);
    }
     ...
     */
    protected function getLoginFormAuthAuthenticatorService()
    {
        ...
        return $this->privates['App\\Security\\LoginFormAuthAuthenticator'] = new \App\Security\LoginFormAuthAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3kMp8YFCtb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YaYxM+85yq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSecurity_Authentication_FormEntryPoint_MainService()
    {
        ...
        return $this->privates['security.authentication.form_entry_point.main'] = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint(($this->services['http_kernel'] ?? $this->getHttpKernelService()), ($this->privates['security.http_utils'] ?? $this->getSecurity_HttpUtilsService()), 'app_login', false);
    }
    ...
    protected function getSecurity_Authentication_Listener_Basic_MainService()
    {
        ...
        $this->privates['security.authentication.listener.basic.main'] = $instance = new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'main', ($this->privates['security.authentication.form_entry_point.main'] ?? $this->getSecurity_Authentication_FormEntryPoint_MainService()), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    ...
    protected function getSecurity_Authentication_Listener_Guard_MainService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.main'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'main', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\LoginFormAuthAuthenticator'] ?? $this->getLoginFormAuthAuthenticatorService());
        }, 1), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), true);
    }
    ...
    protected function getSecurity_Authentication_Provider_Guard_MainService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\LoginFormAuthAuthenticator'] ?? $this->getLoginFormAuthAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.our_db_provider'] ?? $this->getSecurity_User_Provider_Concrete_OurDbProviderService()), 'main', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        ...
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.user.provider.concrete.our_db_provider'] ?? $this->getSecurity_User_Provider_Concrete_OurDbProviderService());
            yield 2 => ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_AppUserProviderService());
        }, 3), 'main', ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), [0 => ($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->privates['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () {
            ...
            yield 4 => ($this->privates['security.authentication.listener.basic.main'] ?? $this->getSecurity_Authentication_Listener_Basic_MainService());
        ...
        }, 7), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), $b, 'main', ($this->privates['security.authentication.form_entry_point.main'] ?? $this->getSecurity_Authentication_FormEntryPoint_MainService()), NULL, NULL, ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), false), $c, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', '.security.request_matcher.3UEFixr', true, false, 'security.user.provider.concrete.our_db_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, [0 => 'guard', 1 => 'form_login', 2 => 'http_basic', 3 => 'anonymous'], NULL), ($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder6617f = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer75871 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties16e6a = [
        
    ];

    public function getConnection()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getConnection', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getMetadataFactory', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getExpressionBuilder', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'beginTransaction', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getCache', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getCache();
    }

    public function transactional($func)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'transactional', array('func' => $func), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->transactional($func);
    }

    public function commit()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'commit', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->commit();
    }

    public function rollback()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'rollback', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getClassMetadata', array('className' => $className), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'createQuery', array('dql' => $dql), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'createNamedQuery', array('name' => $name), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'createQueryBuilder', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'flush', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'clear', array('entityName' => $entityName), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->clear($entityName);
    }

    public function close()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'close', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->close();
    }

    public function persist($entity)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'persist', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'remove', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'refresh', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'detach', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'merge', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getRepository', array('entityName' => $entityName), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'contains', array('entity' => $entity), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getEventManager', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getConfiguration', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'isOpen', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getUnitOfWork', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getProxyFactory', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'initializeObject', array('obj' => $obj), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'getFilters', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'isFiltersStateClean', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'hasFilters', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return $this->valueHolder6617f->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer75871 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder6617f) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder6617f = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder6617f->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, '__get', ['name' => $name], $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        if (isset(self::$publicProperties16e6a[$name])) {
            return $this->valueHolder6617f->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder6617f;
    ...
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;
    ...
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, '__isset', array('name' => $name), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;
    ...
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, '__unset', array('name' => $name), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;
    ...
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, '__clone', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        $this->valueHolder6617f = clone $this->valueHolder6617f;
    }

    public function __sleep()
    {
        $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, '__sleep', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;

        return array('valueHolder6617f');
    }
    ...
    {
        $this->initializer75871 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer75871;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer75871 && ($this->initializer75871->__invoke($valueHolder6617f, $this, 'initializeProxy', array(), $this->initializer75871) || 1) && $this->valueHolder6617f = $valueHolder6617f;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder6617f;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder6617f;
    }
